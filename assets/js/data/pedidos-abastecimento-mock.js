...
window.CatalogoExtraProdutos = (window.GoflashProdutosDatabase ? window.GoflashProdutosDatabase.produtos.filter(p => p.id > 7) : [
  {
    id: 8,
    ean: '7891149103102',
...
window.CatalogoCompletoProdutos = window.GoflashProdutosDatabase ? window.GoflashProdutosDatabase.produtos : [
  ...window.ConsultaProdutosBase,
